...
tf.flags.DEFINE_string('X', '/GPUFS/nsccgz_ywang_1/quyili/MultimodalGeneration/mydata/real_1F_enhancement_20_MRI/T1', 'X files for training')
tf.flags.DEFINE_string('Y', '/GPUFS/nsccgz_ywang_1/quyili/MultimodalGeneration/mydata/real_1F_enhancement_20_MRI/T2', 'Y files for training')
tf.flags.DEFINE_string('Z', '/GPUFS/nsccgz_ywang_1/quyili/MultimodalGeneration/mydata/real_1F_enhancement_20_MRI/T1c', 'X files for training')
tf.flags.DEFINE_string('W', '/GPUFS/nsccgz_ywang_1/quyili/MultimodalGeneration/mydata/real_1F_enhancement_20_MRI/Flair', 'Y files for training')
tf.flags.DEFINE_string('L', '/GPUFS/nsccgz_ywang_1/quyili/MultimodalGeneration/mydata/real_1F_enhancement_20_MRI/Label', 'Y files for training')
tf.flags.DEFINE_string('X_test', '/GPUFS/nsccgz_ywang_1/quyili/MultimodalGeneration/mydata/BRATS2015/testT1', 'X files for training')
tf.flags.DEFINE_string('Y_test', '/GPUFS/nsccgz_ywang_1/quyili/MultimodalGeneration/mydata/BRATS2015/testT2', 'Y files for training')
tf.flags.DEFINE_string('Z_test', '/GPUFS/nsccgz_ywang_1/quyili/MultimodalGeneration/mydata/BRATS2015/testT1c', 'X files for training')
tf.flags.DEFINE_string('W_test', '/GPUFS/nsccgz_ywang_1/quyili/MultimodalGeneration/mydata/BRATS2015/testFlair', 'Y files for training')
...
tf.flags.DEFINE_integer('epoch', 84, 'default: 100')
tf.flags.DEFINE_float('display_epoch', 1, 'default: 1')
tf.flags.DEFINE_integer('epoch_steps', 18084, '463 or 5480, default: 5480')
