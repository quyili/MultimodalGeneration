...
tf.flags.DEFINE_string('X', '/GPUFS/nsccgz_ywang_1/quyili/MultimodalGeneration/mydata/real_1F_enhancement_2F_MRI/T1', 'X files for training')
tf.flags.DEFINE_string('Y', '/GPUFS/nsccgz_ywang_1/quyili/MultimodalGeneration/mydata/real_1F_enhancement_2F_MRI/T2', 'Y files for training')
tf.flags.DEFINE_string('Z', '/GPUFS/nsccgz_ywang_1/quyili/MultimodalGeneration/mydata/real_1F_enhancement_2F_MRI/T1c', 'X files for training')
tf.flags.DEFINE_string('W', '/GPUFS/nsccgz_ywang_1/quyili/MultimodalGeneration/mydata/real_1F_enhancement_2F_MRI/Flair', 'Y files for training')
tf.flags.DEFINE_string('L', '/GPUFS/nsccgz_ywang_1/quyili/MultimodalGeneration/mydata/real_1F_enhancement_2F_MRI/Label', 'Y files for training')
...
tf.flags.DEFINE_integer('epoch', 34, 'default: 100')
