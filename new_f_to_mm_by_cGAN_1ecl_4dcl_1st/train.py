...
tf.flags.DEFINE_integer('epoch', 20, 'default: 100')
...
tf.flags.DEFINE_string('load_seg_model', "/GPUFS/nsccgz_ywang_1/quyili/MultimodalGeneration/SEG/mm_to_label_1ecl_4dcl/checkpoints/20190801-1443",
                       'folder of saved model that you wish to continue training (e.g. 20170602-1936), default: None')
