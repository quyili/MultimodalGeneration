...
class GAN:
    ...
    def model(self, l, l_m, m, l_x, l_y, l_z, l_w, x, y, z, w):
        ...
        l_g_prob_by_x, l_g_by_x = self.segmentation(x_g)
        l_g_prob_by_y, l_g_by_y = self.segmentation(y_g)
        l_g_prob_by_z, l_g_by_z = self.segmentation(z_g)
        l_g_prob_by_w, l_g_by_w = self.segmentation(w_g)
