...
tf.flags.DEFINE_string('X', './train/NEW_X', 'X files for training')
tf.flags.DEFINE_string('F', './train/NEW_F', 'Y files for training')
tf.flags.DEFINE_string('M', './train/NEW_M', 'Y files for training')
tf.flags.DEFINE_string('X_test', './test/X', 'Y files for training')
tf.flags.DEFINE_string('F_test', './test/NEW_F', 'Y files for training')
tf.flags.DEFINE_string('M_test', './test/M', 'Y files for training')
