...
tf.flags.DEFINE_string('M', './DATA/TC19/train/M', 'X files for training')
tf.flags.DEFINE_string('F', './DATA/TC19/train/F', 'X files for training')
tf.flags.DEFINE_string('M_test', './DATA/TC19/test/M', 'X files for training')
tf.flags.DEFINE_string('F_test', './DATA/TC19/test/F', 'X files for training')
