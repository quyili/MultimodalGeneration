...
tf.flags.DEFINE_string('L', '../../../../data/BRATS2015/test/L', 'files path')
...
tf.flags.DEFINE_string('L_test', '../../../../data/BRATS2015/test/L', 'files path')
tf.flags.DEFINE_string('load_model', None,'e.g. 20200101-2020, default: None')
tf.flags.DEFINE_string('load_GT_model', "20200101-2020", 'e.g. 20170602-1936, default: None')
            ...
            with tf.variable_scope(tf.get_variable_scope()):
                ...
                with tf.device("/gpu:1"):
                    with tf.name_scope("GPU_1"):
                        ...
                        loss_list_1,image_list_1,judge_list_1 = gan.model(l_0,m_1,s_1,x_1, y_1, z_1, w_1)
                ...
                with tf.device("/gpu:2"):
                    with tf.name_scope("GPU_2"):
                        ...
                        loss_list_2,image_list_2,judge_list_2  = gan.model(l_2,m_2,s_2,x_2, y_2, z_2, w_2)
                ...
                with tf.device("/gpu:3"):
                    with tf.name_scope("GPU_3"):
                        ...
                        loss_list_3,image_list_3,judge_list_3 = gan.model(l_3,m_3,s_3,x_3, y_3, z_3, w_3)
                ...
                while epoch <= FLAGS.epoch:
                    ...
                    for b in range(FLAGS.batch_size):
                        ...
                        while True:
                            ...
                            if np.sum(train_m_arr * train_l_arr) == 0.0: break
