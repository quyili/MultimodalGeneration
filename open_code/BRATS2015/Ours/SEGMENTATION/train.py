            ...
            with tf.variable_scope(tf.get_variable_scope()):
                with tf.device("/gpu:0"):
                    with tf.name_scope("GPU_0"):
                        ...
                        loss_list_0,image_list_0 = gan.model(l_0,x_0, y_0, z_0, w_0)
                ...
                with tf.device("/gpu:1"):
                    with tf.name_scope("GPU_1"):
                        ...
                        loss_list_1,image_list_1 = gan.model(l_0,x_1, y_1, z_1, w_1)
                ...
                with tf.device("/gpu:2"):
                    with tf.name_scope("GPU_2"):
                        ...
                        loss_list_2,image_list_2  = gan.model(l_2,x_2, y_2, z_2, w_2)
                ...
                with tf.device("/gpu:3"):
                    with tf.name_scope("GPU_3"):
                        ...
                        loss_list_3,image_list_3 = gan.model(l_3,x_3, y_3, z_3, w_3)
