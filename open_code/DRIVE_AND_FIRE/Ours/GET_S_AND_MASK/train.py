...
tf.flags.DEFINE_string('M', './DATA/SWM/train/M', 'X files for training')
tf.flags.DEFINE_string('F', './DATA/SWM/train/NEW_F', 'X files for training')
tf.flags.DEFINE_string('M_test', './DATA/SWM/test/M', 'X files for training')
tf.flags.DEFINE_string('F_test', './DATA/SWM/test/NEW_F', 'X files for training')
