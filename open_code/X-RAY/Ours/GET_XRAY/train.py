...
tf.flags.DEFINE_string('X', './DATA/chest_xray/train/X', 'X files for training')
tf.flags.DEFINE_string('L', './DATA/chest_xray/train/L', 'Y files for training')
tf.flags.DEFINE_string('F', './DATA/chest_xray/train/NEW_F', 'Y files for training')
tf.flags.DEFINE_string('M', './DATA/chest_xray/train/M', 'Y files for training')
tf.flags.DEFINE_string('X_test', './DATA/chest_xray/test/X', 'X files for training')
tf.flags.DEFINE_string('L_test', './DATA/chest_xray/test/L', 'Y files for training')
tf.flags.DEFINE_string('F_test', './DATA/chest_xray/test/NEW_F', 'Y files for training')
tf.flags.DEFINE_string('M_test', './DATA/chest_xray/test/M', 'Y files for training')
