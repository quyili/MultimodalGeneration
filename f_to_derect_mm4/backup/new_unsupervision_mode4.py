...
class GAN:
    ...
    def translate(self, x, y, cx, cy, l_x, l_y, code_x, code_y, l_f_prob_by_x, l_f_prob_by_y, j_x, j_x_c, j_y, j_y_c,
                  j_code_x, j_code_y, EC_X, EC_Y, DC_X, DC_Y, G_loss=0.0, D_X_loss=0.0, D_Y_loss=0.0,
    ...
    def model(self, x, y, cx, cy, l, f, code_x, code_y, x_g, y_g, code_x_g, code_y_g, l_f_prob_by_x, l_f_prob_by_y,
              l_g_prob_by_x, l_g_prob_by_y, j_x, j_x_c, j_y, j_y_c, j_x_g, j_x_g_c, j_y_g, j_y_g_c, j_code_x, j_code_y,
              EC_X, EC_Y, DC_X, DC_Y):
