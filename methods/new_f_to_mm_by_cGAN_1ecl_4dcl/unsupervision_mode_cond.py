...
class GAN:
    ...
    def model(self, l, l_m, m, l_x, l_y, l_z, l_w, x, y, z, w):
        ...
        l_f_prob_by_x, l_f_by_x = self.segmentation(x, self.EC_L, self.DC_L_X)
        l_f_prob_by_y, l_f_by_y = self.segmentation(y, self.EC_L, self.DC_L_Y)
        l_f_prob_by_z, l_f_by_z = self.segmentation(z, self.EC_L, self.DC_L_Z)
        l_f_prob_by_w, l_f_by_w = self.segmentation(w, self.EC_L, self.DC_L_W)
