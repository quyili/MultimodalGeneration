...
tf.flags.DEFINE_string('X', '/GPUFS/nsccgz_zgchen_2/quyili/DATA/SWM/train/X', 'X files for training')
tf.flags.DEFINE_string('F', '/GPUFS/nsccgz_zgchen_2/quyili/DATA/SWM/train/F', 'Y files for training')
tf.flags.DEFINE_string('M', '/GPUFS/nsccgz_zgchen_2/quyili/DATA/SWM/train/M', 'Y files for training')
tf.flags.DEFINE_string('X_test', '/GPUFS/nsccgz_zgchen_2/quyili/DATA/SWM/test/X', 'Y files for training')
tf.flags.DEFINE_string('F_test', '/GPUFS/nsccgz_zgchen_2/quyili/DATA/SWM/test/F', 'Y files for training')
tf.flags.DEFINE_string('M_test', '/GPUFS/nsccgz_zgchen_2/quyili/DATA/SWM/test/M', 'Y files for training')
