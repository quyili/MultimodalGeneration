...
class GAN:
    ...
    def model(self, f):
        ...
        D_loss += self.mse_loss(j_code_f_rm, 1.0) * 0.15
        D_loss += self.mse_loss(j_code_f, 0.0) * 0.15
        FG_loss += self.mse_loss(j_code_f, 1.0) * 0.25
        ...
        FG_loss += self.mse_loss(f_one_hot, f_r_prob) * 100
