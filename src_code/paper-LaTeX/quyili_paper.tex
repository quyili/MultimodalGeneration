...
\begin{figure}[thbp!]
	...
	\caption{脑部MRI合成效果对比。（a） PGGAN\cite{100karras2017progressive,96zhang2019skrgan:}的合成图像，（b） WGAN\cite{99arjovsky2017wasserstein,96zhang2019skrgan:}的合成图像， （c） DCGAN\cite{97radford2015unsupervised,96zhang2019skrgan:}的合成图像，（d） ACGAN\cite{98odena2016conditiona,96zhang2019skrgan:l}的合成图像，（e） SkrGAN\cite{96zhang2019skrgan:}的合成图像、输入的结构特征图的二值反转图像，（f） 本研究的方案的合成图像和输入的结构特征图。（a）-（e）为在Neuromorphometrics脑MRI数据集上满足一些未知条件的筛选出的数据上进行训练的合成效果，（f） 在BRATS2015上合成训练。}
	\label{generated_MRI}
\end{figure}
...
[1].基于条件生成对抗网络的多模态MRI转换方法、系统及介质,申请中发明专利,专利申请号201910765217.4,2019.08.19.瞿毅力,苏琬棋,邓楚富,王莹,卢宇彤,陈志广.(第一作者)

[2].生成配准的带病灶分割标签的多模态MRI的方法、系统及介质,申请中发明专利,专利申请号201910764408.9,2019.08.19.瞿毅力,王莹,苏琬棋,邓楚富,卢宇彤,陈志广.(第一作者)

[3].一种基于进化算法的卷积神经网络结构搜索方法及系统,已公开发明专利,专利公开号CN109299142A,2019.02.01.卢宇彤,瞿毅力,郑馥丹,陈志广.(除导师外第一作者)

[4].可使具有全连接层的CNN接受不定形状输入的方法及系统,已公开发明专利,专利公开号CN109583584A,2019.04.05.卢宇彤,瞿毅力,陈志广.(除导师外第一作者)

[5].基于GAN的多模态低剂量CT转换高剂量CT的方法、系统及介质,申请中发明专利,专利申请号201910832520.1,2019.09.04.苏琬棋,瞿毅力,邓楚富,王莹,陈志广,卢宇彤.(第二作者)

[6].一种基于生成对抗网络的多域图像转换方法与系统,已公开发明专利,专利公开号CN110084863A,2019.08.02.苏琬棋, 陈志广,瞿毅力,邓楚富,卢宇彤,肖侬,王莹.(除导师外第二作者)

[7].基于模块化GAN的多模态MRI与多模态CT的转换方法、系统及介质,申请中发明专利,专利申请号201910880585.3,2019.09.18.苏琬棋,瞿毅力,邓楚富,王莹,卢宇彤,陈志广,肖侬.(第二作者)

[8].基于条件生成对抗网络的多域图像转换方法、系统及介质,申请中发明专利,专利申请号201910808016.8,2019.08.29.邓楚富,肖侬,卢宇彤,陈志广,瞿毅力,苏琬棋,王莹.(除导师外第二作者)
