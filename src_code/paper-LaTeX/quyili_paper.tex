...
总的来说，当前的合成医学影像的研究中还存在模态数量少、训练数据要求配准、不能有效合成病灶、无法从随机噪声无限合成、需要额外的数据产生生理结构信息、合成质量评价不客观等各项未能很好解决的问题。本研究的目的正是针对上述的这些问题，基于当前的技术和研究成果，进一步出探索一套完整的可以同时解决上述多个问题的解决方案。
