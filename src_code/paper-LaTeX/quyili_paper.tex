...
[3].深度学习在定量降水预报统计后处理上的应用.中山大学优秀研究生创新发展项目.依托项目:面向大数据的高性能计算支撑系统研究,依托项目负责人:肖侬.项目负责人:徐风扬.承担单位:中山大学.(项目组主要成员)

[4].基于GAN的带病灶标签的多模态配准医学影像的合成.中山大学优秀研究生创新发展项目.依托项目:面向典型应用的虚拟数据空间验证与优化,依托项目负责人:陈志广.项目负责人:苏琬棋.承担单位:中山大学.(项目组主要成员)
