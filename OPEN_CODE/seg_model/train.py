...
tf.flags.DEFINE_string('X_test', '/GPUFS/nsccgz_ywang_1/quyili/MultimodalGeneration/G_MRI/new_f_to_mm_by_cGAN_1ecl_4dcl/test_images/T1', 'X files for training')
tf.flags.DEFINE_string('Y_test', '/GPUFS/nsccgz_ywang_1/quyili/MultimodalGeneration/G_MRI/new_f_to_mm_by_cGAN_1ecl_4dcl/test_images/T2', 'Y files for training')
tf.flags.DEFINE_string('Z_test', '/GPUFS/nsccgz_ywang_1/quyili/MultimodalGeneration/G_MRI/new_f_to_mm_by_cGAN_1ecl_4dcl/test_images/T1c', 'X files for training')
tf.flags.DEFINE_string('W_test', '/GPUFS/nsccgz_ywang_1/quyili/MultimodalGeneration/G_MRI/new_f_to_mm_by_cGAN_1ecl_4dcl/test_images/Flair', 'Y files for training')
tf.flags.DEFINE_string('L_test', '/GPUFS/nsccgz_ywang_1/quyili/MultimodalGeneration/G_MRI/new_f_to_mm_by_cGAN_1ecl_4dcl/test_images/Label', 'Y files for training')
                ...
                if FLAGS.stage == "train":
                    ...
                    while not coord.should_stop() and epoch <= FLAGS.epoch:
                        ...
                        if step == 0 or step % int(FLAGS.epoch_steps / 2 - 1) == 0 or step == int(
                            ...
                            for j in range(int(math.ceil(len(l_x_val_files) / FLAGS.batch_size))):
                                val_true_l_x = []
                                val_true_l_y = []
                                val_true_l_z = []
                                val_true_l_w = []
